...
# TODO: Report CFISan issue and remove `$(filter-out -fsanitize=cfi)`
...
$(CIONOM_LIB): CFLAGS = $(GEN_CORE_CFLAGS) $(CIONOM_DIAGNOSTIC_CFLAGS)
$(CIONOM_LIB): LFLAGS = $(GEN_CORE_LFLAGS)
$(CIONOM_LIB): LIBDIRS = $(GEN_CORE_LIBDIRS)
$(CIONOM_LIB): $(CIONOM_LIB_OBJECTS) $(GEN_CORE_LIB) | $(CIONOM_DIR)/lib

$(CIONOM_EXEC): CFLAGS = $(CIONOM_LIB_CFLAGS) $(CIONOM_DIAGNOSTIC_CFLAGS) -DCIO_CLI_VERSION="\"@$(shell $(GIT) rev-parse --short HEAD)\""
$(CIONOM_EXEC): LFLAGS = $(CIONOM_LIB_LFLAGS)
$(CIONOM_EXEC): LIBDIRS = $(CIONOM_LIB_LIBDIRS)
$(CIONOM_EXEC): $(CIONOM_EXEC_OBJECTS) $(CIONOM_LIB)

$(CIONOM_EXTERNAL): CFLAGS = $(CIONOM_LIB_CFLAGS) $(CIONOM_DIAGNOSTIC_CFLAGS)
$(CIONOM_EXTERNAL): LFLAGS = $(CIONOM_LIB_LFLAGS)
